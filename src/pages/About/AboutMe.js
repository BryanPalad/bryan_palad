  ...
  return (
    <div>
      <p className="font-subtitle mb-2 text-justify text-black dark:text-white">
        ...
        Working extensively with languages like C#, MySQL and PHP during this time 
        ignited my love for programming.
        <br />
        <br />
        Following graduation, I embarked on a different path, I worked for over 2 years
        ...
        in software development. Today, with 9 months of hands-on experience, 
