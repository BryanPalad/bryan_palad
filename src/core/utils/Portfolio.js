...
export const projectsData = [
    ...
    },
    {
      ...
      category: "mini projects",
      description: "A simple app that gets the actual weather status and news depending on the search locations, built in react js and redux toolkit and used 3 API's (Open Weather API's and Bing News Api). ",
    ...
    },
    {
      ...
      techStacks: ['Laravel','TailwindCss','MySQL'],
      pointer: false,
      demo: "",
