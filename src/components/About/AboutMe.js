  ...
  return (
    <div>
      <p className="mb-2 text-justify text-black dark:text-white">
        ...
        lead programmer on our 2 thesis projects and had a hands-on experience using C#,
        MySQL and PHP despite not having enough resources such as stable
        internet connection for self learning.
        <br />
        <br />
