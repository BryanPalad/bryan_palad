          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            <div className="flex flex-col">
              ...
              <p className="mb-2 text-justify">
                {age} years old, BS Information Technology graduate year 2019, became a lead
                ...
                about time to get back to coding and i've decided to leave my
                current job, move forward and pursue this programming career.
              </p>
            </div>
            <Fade bottom>
